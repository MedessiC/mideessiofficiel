...
import { Calendar, User, ArrowRight, TrendingUp, Search } from 'lucide-react';
        ...
        <div className="flex flex-col md:flex-row gap-4 mb-8">
          <div className="relative flex-1">
            ...
            <input
              ...
              className="w-full pl-12 pr-4 py-3 bg-corporate-50 dark:bg-gray-800 border border-corporate-200 dark:border-gray-700 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-600 text-midnight dark:text-white"
            />
          </div>
          <select
            value={selectedCategory}
            onChange={(e) => setSelectedCategory(e.target.value)}
            className="px-6 py-3 bg-corporate-50 dark:bg-gray-800 border border-corporate-200 dark:border-gray-700 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-600 text-midnight dark:text-white"
          >
