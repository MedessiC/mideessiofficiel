  ...
  return (
    <div className="min-h-screen pt-16 bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-800">
      <div className="max-w-7xl mx-auto px-3 sm:px-4 md:px-6 lg:px-8 py-4 md:py-8">
        {/* Header - Responsive */}
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 md:gap-6 mb-8">
          <div>
        ...
        {/* Tabs Navigation */}
        <div className="flex gap-2 md:gap-4 mb-8 border-b border-gray-200 dark:border-gray-700 overflow-x-auto">
          <button
        ...
        {activeTab === 'blog' && (
          <>
            ...
            {/* Blog Content */}
            <div className="bg-white dark:bg-gray-800 rounded-lg md:rounded-xl border border-gray-200 dark:border-gray-700 shadow-sm p-4 md:p-6 mb-8">
              <div className="flex items-center justify-between mb-6">
                <h2 className="text-xl font-bold text-gray-900 dark:text-white">Articles du blog</h2>
                <Link
                  to="/admin/post/new"
